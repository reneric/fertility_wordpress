...
<ul style="background:none;margin:0px;padding:0px">
	...
	<div class="ssbutton" style="width:182px;text-align:center; top:-10px; margin-top:-100px; margin: 0px auto; padding: 0px 0px 0 10px;  position: relative;  z-index: 200;">
	<a href="#" class="ssprev"><span id="prev92"><img src="<?php echo get_template_directory_uri(); ?>/images/mod_ppc_simple_spotlight/img/button/button-prev.png" title="Previous" alt="Previous" /></span></a> 
	<a href="#" class="ssnext"><span id="next92"><img src="<?php echo get_template_directory_uri(); ?>/images/mod_ppc_simple_spotlight/img/button/button-next.png" title="Next" alt="Next" /></span></a>
    </div>
</div>
		</div>
