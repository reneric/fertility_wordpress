...
if ($params->get('show20')){		
	...
	<div class="ssbutton" style="width:<?php echo ($width)-15 ?>px;text-align:<?php echo ($buttons) ?>; top:-10px; margin-top:-100px; margin: 0px auto; padding: 0px 0px 0 10px;  position: relative;  z-index: 200;">
